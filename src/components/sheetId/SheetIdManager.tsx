		...
		<div className='sheetIdManager_container'>
			...
			<div className="sheetIdManager_area">
				<div className="input-field">
					<input type="text" placeholder="Spreadsheet id, found after 'spreadsheets/d/'" value={sheetIdInput} onChange={(e) => setSheetIdInput(e.target.value)} />
				</div>
				{sheetIdInput !== sheetId ? <a className="sheetIdManager_control new" onClick={handleSave}><MdOutlineSave /></a> : null}
			</div>
		</div>
	);
}
